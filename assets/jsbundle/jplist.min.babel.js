  ...
  var s = function () {
    ...
    return o(e, [{
      ...
      value: function value(e) {
        ...
        for (var t = [].concat(u(document.querySelectorAll("[data-jplist-item]"))), r = 0; r < t.length; r++) {
          t[r].jplistIndex = r;
        }
      ...
      value: function value(e) {
        ...
        for (var m = [].concat(u(document.querySelectorAll("[data-jplist-item]"))), g = 0; g < m.length; g++) {
          m[g].jplistIndex = g;
        }
